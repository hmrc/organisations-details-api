...
case class VatReturnsDetailsResponse(
  vrn: Option[String],
...
object VatReturnsDetailsResponse {
  implicit val vatReturnsDetailsResponseFormat: OFormat[VatReturnsDetailsResponse] =
    Json.format[VatReturnsDetailsResponse]
