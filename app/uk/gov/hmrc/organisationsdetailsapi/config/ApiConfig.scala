...
case class ScopeConfig(name: String, fields: List[String], endpoints: List[String], filters: List[String] = List()) {}
...
case class ExternalEndpointConfig(name: String, link: String, title: String, key: String) extends EndpointConfig
